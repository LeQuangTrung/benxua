...
<!-- END switch_display_menu -->
	...
	<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post" name="post" id="ucp" class="frm-form">
		...
		<div class="main-content frm">
			<p class="frm-info">Vui lòng hoàn thành những nội dung bên dưới</p>
			<fieldset class="frm-set multi">
				...
				<dl>
						...
						<dd><a href="{LINK_FOR_PASSWD_CHANGE}" target="_blank"><b>Thay đổi mật khẩu</b></a></dd>
				</dl>
...
<fieldset class="frm-set">
<dl>
        <dt><label>Nhập mật khẩu hiện tại&nbsp;: *</label></dt>
